...
<body background="assets/img/fondo.jpg">
    ...
    <div class="container  outer-section shadow-lg rounded" >        

        <div id="print-area rounded">

                  <div class="row pad-top font-big rouded ">

                <div class="col-lg-3 col-md-4 col-sm-4">

                  <a href="" target="_blank">  <img src="assets/img/logo.jpg" alt="Logo sistemas web" /></a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    <strong>Sistema Web MG software </strong>

                    <br />

                    Dirección : Cra 27 # 39 -32 sur
