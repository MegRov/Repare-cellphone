...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%;  text-align: center; font-size: 10pt;">
        ...
        <tr>
            ...
            <td style="width: 40%">Fisuras/Quebraduras</td>            
        ...
        <tr>
            ...
            <td style="width: 40%">Pintura dañada</td>            
        ...
        <tr>
            ...
            <td style="width: 40%">Golpes graves</td>            
        ...
        <tr>
            ...
            <td style="width: 40%">Golpes leves</td>            
